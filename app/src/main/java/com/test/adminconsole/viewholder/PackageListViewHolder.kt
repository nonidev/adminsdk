...
import kotlinx.android.synthetic.main.row_packages.view.*
 ...
 */
class PackageListViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView) {
    private val TAG = javaClass.simpleName

    private var model: PackageListModel? = null

    internal fun bind(model: PackageListModel) {
        this.model = model

        itemView.tvAppName.text = model.app_name
        itemView.tvPackageName.text = model.app_package
